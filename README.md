...
Las máquinas de anestesia son equipos biomédicos fundamentales dentro del entorno quirúrgico, ya que permiten mantener al paciente en un estado controlado de inconsciencia, garantizando simultáneamente ventilación, oxigenación y administración segura de agentes anestésicos.

En esta práctica se realizó el reconocimiento funcional de la máquina de anestesia WATO EX-20, identificando sus principales subsistemas, modos de ventilación, componentes respiratorios y procedimientos de seguridad y mantenimiento.
...
- **Anestesia espinal:** utilizada para cirugía abdominal inferior, pélvica, rectal o de las extremidades inferiores, mediante una dosis única del anestésico en el espacio subaracnoideo.
- **Anestesia epidural:** ampliamente utilizada en partos y cesáreas.
...
| Óxido Nitroso (N₂O) | Potenciar el efecto anestésico |
| Aire medicinal | Funcionar como gas portador y diluyente |
...
- Llevar oxígeno, aire, N₂O y anestésico hacia el paciente.
- Permitir ventilación manual o mecánica.
- Retirar o absorber el CO₂ exhalado.
- Mantener presiones y volúmenes respiratorios seguros.
- Evacuar gases residuales hacia el sistema de eliminación de gases anestésicos.
...
- Tubos respiratorios.
- Pieza en Y.
- Mascarilla compatible.
- Válvulas inspiratoria y espiratoria.
- Conjunto del fuelle.
- Recipiente absorbente de CO₂ compatible.
- Algunas partes metálicas o de vidrio del sistema respiratorio.

### Componentes que no deben autoclavarse
...
El ventilador de la WATO EX-20 presenta diferentes modos de ventilación que permiten adaptarse a las necesidades clínicas del paciente.
...
# Componentes principales de la WATO EX-20
...
Cuando el ventilador muestra el mensaje “batería en uso”, significa que el equipo perdió alimentación eléctrica y está funcionando con su batería interna.

La acción inmediata debe ser:

1. No desconectar al paciente.
2. Verificar la causa de pérdida de energía.
3. Reconectar el equipo a la red eléctrica lo antes posible.
4. Preparar ventilación manual como contingencia en caso de agotamiento de batería.

## Reemplazo del absorbente de CO₂

El recipiente absorbente debe reemplazarse cuando el indicador colorimétrico cambie de color, indicando agotamiento de la cal sodada.

### Recomendaciones

- Revisar antes de cada procedimiento.
- Supervisar durante cirugías largas.
- Reemplazar si existe duda sobre su capacidad absorbente.

En condiciones normales, el absorbente puede agotarse aproximadamente cada 6–8 horas de uso continuo.

## Verificación de fugas en cilindros de alta presión

Procedimiento:

1. Conectar el cilindro.
2. Abrir lentamente la válvula.
3. Observar el manómetro.
4. Cerrar la válvula.
5. Esperar 30 segundos.
6. Verificar si la presión disminuye.
7. Aplicar agua jabonosa para localizar fugas.
8. No utilizar llamas ni fuentes de ignición.

## Influencia del sensor de O₂

El sensor de O₂ influye directamente en la prueba del sistema de control de flujo.

### Con sensor instalado

- Verificación completa de FiO₂.
- Alarmas de baja concentración de oxígeno.
- Mayor seguridad clínica.

### Sin sensor

- No se verifica concentración real de O₂.
- El sistema pierde capacidad de monitoreo independiente.
- Pueden aparecer advertencias funcionales.

## Sistema de presión negativa y evacuación de gases

El sistema de presión negativa corresponde al sistema de evacuación de gases anestésicos residuales (AGSS).

Su propósito es eliminar gases anestésicos sobrantes y proteger al personal médico frente a exposiciones prolongadas.
...
La WATO EX-20 también dispone de un sistema auxiliar de succión para procedimientos clínicos.
...
La práctica permitió comprender el funcionamiento general de la máquina de anestesia WATO EX-20 y reconocer la importancia de cada uno de sus subsistemas dentro del entorno quirúrgico.

Además, se identificó la relevancia de los procedimientos de mantenimiento, pruebas de fugas, monitoreo de gases y sistemas de seguridad para garantizar una administración anestésica segura.

Finalmente, se evidenció que el correcto funcionamiento de la máquina depende tanto del estado técnico del equipo como del adecuado manejo por parte del personal clínico.

---

# Referencias

1. Manual de operación y servicio de la máquina de anestesia Mindray WATO EX-20.  
2. Dosch, M. P. *The Anesthesia Machine*.  
